...
import com.JavaLab.online_bank.service.impl.*;
import com.JavaLab.online_bank.utils.Consts;
...
import static com.JavaLab.online_bank.utils.Consts.CompanyNames;
import static com.JavaLab.online_bank.utils.Consts.PeopleNames;
	...
	public void run(String... args) throws Exception {
		...
		while (true) {
			...
			if (action.equals("b")) {
				...
				Long bankIdToPrint = Long.valueOf(scanner.nextInt());
				scanner.nextLine();
				...
				Long userIdToPrint = Long.valueOf(scanner.nextInt());
				scanner.nextLine();
